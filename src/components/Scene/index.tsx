...
import { table as raceTrackTableData } from '../../config/racetrack'
...
export default class Scene extends Component<SceneProps> {
    ...
    calcRaceTrackCenterOffset() {
        const btnStart = raceTrackTableData.find((item: any) => item.key === 'bn-11') as any
        const btnEnd = raceTrackTableData.find((item: any) => item.key === 'bn-12') as any
    ...
    drawRaceTrackTable(): void {
        const centerOffset = this.calcRaceTrackCenterOffset()
        ...
        for( let i = 0; i < 37; i++ ) {
            const btn = raceTrackTableData.find((item: any) => {
                return item.key === `bn-${ i }`
            })
        ...
        let btn11 = raceTrackTableData.find((item: any) => (item.key === `bn-11`)) as any
        let btn12 = raceTrackTableData.find((item: any) => (item.key === `bn-12`)) as any
        const topLeftPos = {
            x: btn11?.x,
            y: btn11?.y
        }
        ...
        for( let i = 0; i < 37; i++ ) {
            const btn = raceTrackTableData.find((item: any) => item.key === `bn-${ i }`) as any
        ...
        /** draw center lines */
        const btn6 = raceTrackTableData.find((item: any) => item.key === `bn-6`) as any
        const btn1 = raceTrackTableData.find((item: any) => item.key === `bn-1`) as any
        ...
        const btn25 = raceTrackTableData.find((item: any) => item.key === `bn-25`) as any
        const btn22 = raceTrackTableData.find((item: any) => item.key === `bn-22`) as any
        ...
        const btn15 = raceTrackTableData.find((item: any) => item.key === `bn-15`) as any
