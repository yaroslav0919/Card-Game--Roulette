...
export const HeatMapView = () => {
    ...
    useEffect(() => {
        ...
        const heatMapData = [] as any
        Object.keys(betCounts).forEach((key: any) => {
            const item = tableData.find((item: any) => item.key === key)
        ...
        const max = heatMapData.length && heatMapData.reduce((a: any, b: any) => a.count > b.count ? a : b)
