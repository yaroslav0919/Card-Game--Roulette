...
import { IconFavorites2, IconFavoritesVip } from '../Icons'
import OverlayModal from '../OverlayModal/OverlayModal'
import FavoritesWrapper from '../Desktop/FavoritesWrapper/FavoritesWrapper'
    ...
    <>{favoritesShow &&
      ...
      >
        ...
        <div className='favorites__modal'>
          <AnimatePresence>
            <OverlayModal vip={vip} title={title} icon={vip ? <IconFavoritesVip /> : <IconFavorites2 />} onClose={onClose}>
              <motion.div>
                <motion.div
                  variants={variants}
                  initial='hidden'
                  animate='visible'
                  exit='hidden'
                  className='favorites__tabs fav-tabs'
                >
                  <Hammer onTap={() => {
                    setActiveTab(0)
                  }}
                  ...
                  <div className='indicator-fav' style={{ width: '50%', left: `${50 * activeTab}%` }}>
                    <span />
                  </div>
                </motion.div>
              </motion.div>
