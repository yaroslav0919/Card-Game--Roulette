        ...
        <motion.div variants={variants} className='mobile-menu__content sub-page sub-page--settings'>
          ...
          <div className='sub-page__content'>
            <div>
              ...
              <div className='settings__row'>
                <span>{translate('settings.muteChat')}</span>
