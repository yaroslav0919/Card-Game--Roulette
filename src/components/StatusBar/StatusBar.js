...
import { IconBalance, IconBet } from '../Icons'
...
const StatusBar = memo(({ menu }) => {
  ...
  return (
    <>
      <div className={classNames('status-bar-mobile', {
        'status-bar-mobile--menu': menu,
        'status-bar-mobile--bet-waiting': status === State.Open,
        'status-bar-mobile--little-time': lastCall && State.Open === status
      }, {
        'status-bar-mobile--bet-closed': status === State.Playing,
        'status-bar-mobile--waiting-new-session': status === State.Finish
      })}
      >
        <div className='status-bar-mobile__left' ref={ref1}>
          <Hammer onTap={() => {
        ...
        <div className='status-bar-mobile__center'>
        ...
        <div className='status-bar-mobile__right' ref={ref2}>
          <Hammer onTap={() => {
